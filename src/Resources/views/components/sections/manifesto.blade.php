...
<section class="py-16 md:py-24 px-6 border-b border-[#2e2224]/15 text-center" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}" style="--section-bg: {{ $bgColor }}; --section-color: {{ $textColor }}; background-color: var(--section-bg);">
    <div class="max-w-4xl mx-auto reveal">
        <blockquote class="font-serif text-2xl md:text-4xl italic leading-relaxed mb-4" style="color: var(--section-color);">
            {{ $quote }}
        </blockquote>
