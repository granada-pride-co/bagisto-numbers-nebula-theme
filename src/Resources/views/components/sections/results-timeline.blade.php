...
<section class="border-b border-[#2e2224]/15 py-16 px-6 md:px-12" id="results-timeline" dir="{{ $isAr ? 'rtl' : 'ltr' }}" style="--section-bg: {{ $bgColor }}; --section-color: {{ $textColor }}; background-color: var(--section-bg);">
