        ...
        <div class="max-w-md w-full mx-auto px-4">
            ...
            <div class="bg-white border border-[#2e2224] p-8 shadow-xl">
                ...
                <form action="{{ route('shop.customer.session.create') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        <label for="email" class="block font-mono text-xs font-bold uppercase text-[#2e2224] mb-2">
                        ...
                        <input
                            ...
                            class="w-full bg-[#fbf8f1] border border-[#2e2224] px-4 py-3 text-sm font-mono text-[#2e2224] outline-none focus:border-[#bd1765] transition-colors"
                        />
                    </div>

                    <div>
                        <div class="flex items-center justify-between mb-2">
                            <label for="password" class="block font-mono text-xs font-bold uppercase text-[#2e2224]">
                                {{ trans('nc::app.customer.login.password') }} *
                            </label>
                            <a
                                href="{{ route('shop.customers.forgot_password.create') }}"
                                class="font-mono text-[11px] text-[#bd1765] hover:underline"
                            >
                        ...
                        <div class="relative">
                            <input
                                ...
                                placeholder="••••••••"
                                class="w-full bg-[#fbf8f1] border border-[#2e2224] px-4 py-3 text-sm font-mono text-[#2e2224] outline-none focus:border-[#bd1765] transition-colors pe-10"
                            />
                            <button
                                type="button"
                                class="absolute top-1/2 -translate-y-1/2 end-3 text-[#2e2224]/60 hover:text-[#bd1765]"
